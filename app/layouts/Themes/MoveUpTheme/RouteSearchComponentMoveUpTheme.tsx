...
import quickSearchStore from "~/layouts/Store/quickSearchStore";
    ...
    <>
      <div className={`relative`}>
        <input
          ...
          className={`bg-base-100 focus:outline-none text-primary focus:border-2 rounded-xl py-2 px-8  border-primary w-[180px] md:w-[300px]`}
          placeholder="Quick Search..."
        />
        <div
          className={`absolute top-[45%] -translate-y-1/2 right-2  text-primary text-xl`}
        >
